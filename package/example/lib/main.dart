...
import 'package:universal_videoplayer_example/pages/auto_fullscreen_on_rotation.dart';
import 'package:universal_videoplayer_example/pages/auto_hidecontrol_disable.dart';
import 'package:universal_videoplayer_example/pages/basic_example_page.dart';
import 'package:universal_videoplayer_example/pages/basic_example_with_looping_page.dart';
import 'package:universal_videoplayer_example/pages/basic_lock_controls_example_page.dart';
import 'package:universal_videoplayer_example/pages/basic_pip_example_page.dart';
import 'package:universal_videoplayer_example/pages/change_quality_example_page.dart';
import 'package:universal_videoplayer_example/pages/custom_background.dart';
import 'package:universal_videoplayer_example/pages/custom_controls.dart';
import 'package:universal_videoplayer_example/pages/custom_icon_size.dart';
import 'package:universal_videoplayer_example/pages/custom_icons_example.dart';
import 'package:universal_videoplayer_example/pages/custom_subtitles.dart';
import 'package:universal_videoplayer_example/pages/disabled_buttons_example_page.dart';
import 'package:universal_videoplayer_example/pages/fullscreen_example_page.dart';
import 'package:universal_videoplayer_example/pages/gridview_example.dart';
import 'package:universal_videoplayer_example/pages/listview_example.dart';
import 'package:universal_videoplayer_example/pages/m3u8_page_example.dart';
import 'package:universal_videoplayer_example/pages/multi_subtitles.dart';
import 'package:universal_videoplayer_example/pages/network_with_subtitle_page.dart';
import 'package:universal_videoplayer_example/pages/one_page_to_other_page_example.dart';
import 'package:universal_videoplayer_example/pages/only_gestures_example_page.dart';
import 'package:universal_videoplayer_example/pages/pick_file_page_example.dart';
import 'package:universal_videoplayer_example/pages/playback_speed_example_page.dart';
import 'package:universal_videoplayer_example/pages/player_with_header_page.dart';
import 'package:universal_videoplayer_example/pages/portrait_example_page.dart';
import 'package:universal_videoplayer_example/pages/secondary_controls.dart';
import 'package:universal_videoplayer_example/pages/yotube_page_example.dart';
